 ...
 * root — the React Native adapter reaches the bus through the `_internal`
 * backdoor and types the listener locally, exactly like
 * `packages/react/src/internal-bridge.ts`.
 */
 ...
 * stamp `_internal`). The adapters in this monorepo and the SDK live in
 ...
 *
 * Internal — not part of the React Native adapter's public API.
 */
