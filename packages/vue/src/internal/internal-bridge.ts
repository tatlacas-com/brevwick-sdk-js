 ...
 * root — the Vue adapter reaches the bus through the `_internal`
 * backdoor and types the listener locally, the same way the React
 * adapter does in `packages/react/src/internal-bridge.ts`.
 */
 ...
 *
 * Internal — not part of the Vue adapter's public API.
 */
